...
'hover:border-[var(--color-primary)]/40 focus:border-[var(--color-primary)] focus ' +
'focus focus:ring-[var(--color-primary)]/10 outline-none transition-all duration-200';

const btnPrimary =
'w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--color-primary)] ' +
'hover:bg-[var(--color-primary-hover)] disabled disabled ' +
'text-white rounded-xl text-sm font-semibold transition-all duration-200 ' +
'shadow-lg shadow-[var(--color-primary)]/20 hover hover:shadow-[var(--color-primary)]/25 ' +
'active:scale-[0.98]';
      ...
      <div className="w-full max-w-[420px]">
        ...
        {mode === 'forgot-verify' && (
          ...
          >
            ...
            {resetEmail && (
              <p className="text-sm text-[var(--color-text-secondary)] text-center bg-[var(--color-primary-light)] rounded-xl px-4 py-3">
